...
public class XYSRP_Flow {
	...
	public void test() throws Exception {
	    ...
	    Response response = request.get("/Getallroutesbyairline?airline=xy&days=17&skipdays=16&orderby=asc");
	...
	public void test2() throws Exception {
	    ...
	    if (databaseList.size() >= 76) {
	        // Get routes from 31st to 40th (index 30 to 39)
	        List<Database> limitedDatabaseList = databaseList.subList(10, 20);
	...
	public void test3() throws Exception {
	    ...
	    if (databaseList.size() >= 76) {
	        // Get routes from 31st to 40th (index 30 to 39)
	        List<Database> limitedDatabaseList = databaseList.subList(20, 30);
	...
	public void test4() throws Exception {
	    ...
	    if (databaseList.size() >= 76) {
	        // Get routes from 31st to 40th (index 30 to 39)
	        List<Database> limitedDatabaseList = databaseList.subList(30, 40);
